...
from sneakerhub import app, db, bcrypt, mail
from sneakerhub.forms import (RegistrationForm, LoginForm, updateAccountForm, 
...
def account():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('account')) # causes browser to send a GET request. done to avoid 'Post GET redirect pattern'
